...
class ZFDebug_Controller_Plugin_Debug extends Zend_Controller_Plugin_Abstract
{
    ...
    protected function _getVersionPanel()
    {
        $panel = '<h4>ZFDebug v'.$this->_version.'</h4>' .
                 '<p>В©2008-2009 <a href="http://jokke.dk">Joakim NygГҐrd</a> & <a href="http://www.bangal.de">Andreas Pankratz</a></p>' .
    ...
    protected function _headerOutput() {
        ...
        return ('
            ...
            <script type="text/javascript" charset="utf-8">
                ...
                if (typeof window.jQuery == "undefined" && "'.$this->_options['jquery_path'].'".length) {
                    ...
                    window.onload = function(){
                        ...
                        var zfdebugDiv = document.getElementById("ZFDebug_debug");
                        
                        if (ZFDebugLoad) {
                            var ZFDebugLoadSaved = ZFDebugLoad;
                            ZFDebugLoad = null;
                            ZFDebugLoadSaved();
                            ZFDebugLoadSaved = null;
                        }
                        if (typeof window.jQuery == "undefined" && zfdebugDiv && zfdebugDiv.style) {
                            zfdebugDiv.style.display = "none";
