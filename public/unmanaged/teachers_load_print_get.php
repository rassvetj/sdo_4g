...
if(isset($_GET['date'])) {
   $from = $_GET['date']['from']['year']."-".$_GET['date']['from']['month']."-".$_GET['date']['from']['day']." 00:00:00";
   $to = $_GET['date']['to']['year']."-".$_GET['date']['to']['month']."-".$_GET['date']['to']['day']." 23:59:59";
   
   $from_for_smarty = month_name((integer)$_GET['date']['from']['month']) . " " . $_GET['date']['from']['year'];
   $to_for_smarty = month_name((integer)$_GET['date']['to']['month']) . " " . $_GET['date']['to']['year'];
}
...
if($is_report_for_all_people) {
   ...
   $smarty_tpl->assign("teacher", $teachers_for_smarty[$_GET['mid']]);
}
