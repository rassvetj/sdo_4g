...
Refresh.Web.ColorValuePicker.prototype = {
	initialize: function(id) {
		...
		this._hueInput = $P(this.id + '_Hue');
		this._valueInput = $P(this.id + '_Brightness');
		this._saturationInput = $P(this.id + '_Saturation');

		this._redInput = $P(this.id + '_Red');
		this._greenInput = $P(this.id + '_Green');
		this._blueInput = $P(this.id + '_Blue');

		this._hexInput = $P(this.id + '_Hex');
