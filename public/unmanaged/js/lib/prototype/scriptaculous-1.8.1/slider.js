...
Control.Slider = Class.create({
  initialize: function(handle, track, options) {
    ...
    if (Object.isArray(handle)) {
      this.handles = handle.collect( function(e) { return $P(e) });
    } else {
      this.handles = [$P(handle)];
    }
    ...
    this.spans     = this.options.spans ? this.options.spans.map(function(s){ return $P(s) }) : false;
