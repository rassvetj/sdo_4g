...
// +----------------------------------------------------------------------+
// | Authors: Bernd Rцmer <berndr@bonn.edu>                               |
// |          Sebastian Bergmann <sb@sebastian-bergmann.de>               |
// |          Christian Kьhn <ck@chkuehn.de> (escape xml entities)        |
// |          Michele Manzato <michele.manzato@verona.miz.it>             |
// +----------------------------------------------------------------------+
//
// $Id: Node.php,v 1.1.2.2 2009/10/29 08:34:14 cvsup Exp $
//

/**
 * PEAR::XML_Tree_Node
 *
 * @author  Bernd Rцmer <berndr@bonn.edu>
 * @package XML_Tree
