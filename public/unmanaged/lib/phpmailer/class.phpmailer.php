...
class PHPMailer
{
    ...
    */
    ...
    function MailSend($header, $body) {
        ...
        {
            $encheadsub = $this->EncodeHeader($this->Subject);
            $rt = @mail($to, $encheadsub, $body, $header);
        }
    ...
    function SetLanguage($lang_type, $lang_path = "") {
        if(file_exists($lang_path."phpmailer.lang-".$lang_type.".php"))
            include $DOCUMENT_ROOT."/".$lang_path."phpmailer.lang-".$lang_type.".php";
        else if(file_exists($lang_path."phpmailer.lang-en.php"))
            include $DOCUMENT_ROOT."/".$lang_path."phpmailer.lang-en.php";
        else
        {
