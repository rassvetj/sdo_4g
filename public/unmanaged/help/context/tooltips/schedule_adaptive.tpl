        ...
        <script type="text/javascript">
				...
				{?foreach from=$timelines key=type item=timeline?}
	                ...
	                t_{?$type?}.addButton('<a href="schedule.php4?c=modify&sheid=','" target="_blank"><img src="images/icons/edit.gif" border="0" /></a>')
	                ...
	                t_{?$type?}.addCondition('2','{?t?}Процент выполненного{?/t?}&nbsp;&nbsp;{?$tooltip_percent?}','images/icons/i_cond03.gif') // '1' reserved for lesson2lesson link
	                t_{?$type?}.addCondition('3','{?t?}Средний балл по курсу{?/t?}&nbsp;&nbsp;{?$tooltip_average?}','images/icons/i_cond01.gif')
	                t_{?$type?}.addCondition('4','{?t?}Суммарный балл по курсу{?/t?}&nbsp;&nbsp;{?$tooltip_total?}','images/icons/i_cond02.gif')
