...
class ADODB_mssqlnative extends ADOConnection {
	...
	*/
	...
	function _connect($argHostname, $argUsername, $argPassword, $argDatabasename)
	{
        ...
        $connectionInfo = array("Database"=>$argDatabasename,'UID'=>$argUsername,'PWD'=>$argPassword, 'CharacterSet' => $this->characterSet, 'ReturnDatesAsStrings' => $this->returnDatesAsStrings);
        ...
        sqlsrv_query($this->_connectionID, "SET DATEFORMAT ymd");
    ...
    function Concat()
    {
        ...
        array_walk($arr, create_function('&$v', 'if (substr($v, 0, 1) == \'"\' && substr($v, -1) == \'"\') $v = "\'".substr($v, 1, -1)."\'"; $v = "CAST(" . $v . " AS VARCHAR(255))";'));
        $s = implode('+',$arr);
