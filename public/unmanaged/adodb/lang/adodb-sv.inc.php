...
$ADODB_LANG_ARRAY = array (
            ...
            DB_ERROR_CANNOT_DROP        => 'kan inte slдppa',
            DB_ERROR_CONSTRAINT         => 'begrдnsning krдnkt',
            ...
            DB_ERROR_NOSUCHFIELD        => 'inget sеdant fдlt',
            DB_ERROR_NOSUCHTABLE        => 'ingen sеdan tabell',
            DB_ERROR_NOT_CAPABLE        => 'DB backend klarar det inte',
            DB_ERROR_NOT_FOUND          => 'finns inte',
            DB_ERROR_NOT_LOCKED         => 'inte lеst',
            DB_ERROR_SYNTAX             => 'syntaxfel',
            DB_ERROR_UNSUPPORTED        => 'stцds ej',
            DB_ERROR_VALUE_COUNT_ON_ROW => 'vдrde rдknat pе rad',
            DB_ERROR_INVALID_DSN        => 'ogiltig DSN',
            DB_ERROR_CONNECT_FAILED     => 'anslutning misslyckades',
            0	                       => 'inget fel', // DB_OK
            DB_ERROR_NEED_MORE_DATA     => 'otillrдckligt med data angivet',
            DB_ERROR_EXTENSION_NOT_FOUND=> 'utцkning hittades ej',
            DB_ERROR_NOSUCHDB           => 'ingen sеdan databas',
            DB_ERROR_ACCESS_VIOLATION   => 'otillrдckliga rдttigheter'
);
?>