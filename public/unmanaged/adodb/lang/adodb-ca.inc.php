...
$ADODB_LANG_ARRAY = array (
            ...
            DB_ERROR_CONSTRAINT         => 'violaciу de constraint',
            DB_ERROR_DIVZERO            => 'divisiу per zero',
            DB_ERROR_INVALID            => 'no йs vаlid',
            DB_ERROR_INVALID_DATE       => 'la data o l\'hora no sуn vаlides',
            DB_ERROR_INVALID_NUMBER     => 'el nombre no йs vаlid',
            DB_ERROR_MISMATCH           => 'no hi ha coincidиncia',
            ...
            DB_ERROR_NOT_CAPABLE        => 'l\'execuciу secundаria de DB no pot',
            ...
            DB_ERROR_INVALID_DSN        => 'el DSN no йs vаlid',
            DB_ERROR_CONNECT_FAILED     => 'connexiу fallida',
            0	                       => 'cap error', // DB_OK
            DB_ERROR_NEED_MORE_DATA     => 'les dades subministrades sуn insuficients',
            DB_ERROR_EXTENSION_NOT_FOUND=> 'extensiу no trobada',
