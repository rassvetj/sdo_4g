<?php
class Learningsubjects_ImportController extends HM_Controller_Action
{
    private $_importService = null;
    protected $_importManagerClass = 'HM_Learningsubjects_Import_Manager';
    ...
    public function csv()
    {
        ...
        $this->_importService = $this->getService('LearningsubjectsCsv');
    }
    ...
    public function processAction()
    {
        ...
        $importManager = new HM_Learningsubjects_Import_Manager();
