...
class User_RegController extends HM_Controller_Action
{
    ...
    private function createUser(HM_Form_User $form)
    {
        ...
        $array = array(
                   ...
                   'LastNameLat' => $this->FilterString($form->getValue('lastname_en')),//((null !== $form->getValue('lastname_en')) ? $form->getValue('lastname_en') : ''),
                   'FirstNameLat' => $this->FilterString($form->getValue('firstname_en')),//((null !== $form->getValue('firstname_en')) ? $form->getValue('firstname_en') : ''),
