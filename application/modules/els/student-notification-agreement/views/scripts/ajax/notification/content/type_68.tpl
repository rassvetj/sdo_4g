...
<div class="fin-notice" style="3width: 900px;">
	...
	<p style="text-indent: 30px;">
		...
		в размере <?=$this->fine?> руб.
	</p>
	<p style="text-indent: 30px;">
		Важно:</b> Оплату необходимо было произвести <b>до <?=$this->date_to?></b>. 
	</p>
	<p style="text-decoration: underline;">
		Подтверждение о произведенной оплаты необходимо отправить на почту 
		<a href="" target="_blank">dekanat@rgsu.net</a>.
		(в теме письма указать «Оплата. ФИО»)
	</p>
	<p style="text-indent: 30px;">
		...
		<b>При отсутствии оплаты</b>, по истечению <b>60 банковских дней</b> Университет имеет право <b>расторгнуть договор</b> в одностороннем порядке.							
	</p>
