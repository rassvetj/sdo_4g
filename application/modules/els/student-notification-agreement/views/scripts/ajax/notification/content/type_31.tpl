...
<div class="fin-notice" style="3width: 900px;">
	...
	<p>
		<b>Важно:</b> Оплату финансовой задолженности необходимо подтвердить <b>до 24.12.2020</b>. 
	</p>
	<p>
	...
	<p>
		При отсутствии оплаты до указанной даты, 
		договор на оказание образовательных услуг будет расторгнут в одностороннем порядке, 
