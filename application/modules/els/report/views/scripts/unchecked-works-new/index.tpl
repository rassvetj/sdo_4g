...
<b>Дата окончания</b> - период, за который происходит отбор сессий. 
<br />
Отбор идет по полю "дата второго продления", если оно есть.
<br />
Иначе по полю "дата первого продления".
<br />
Если сессия не продлена, то по полю "дата окончания сессии".
<br />	
<br />
