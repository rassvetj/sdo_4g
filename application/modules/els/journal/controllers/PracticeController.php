<?php
class Journal_PracticeController extends HM_Controller_Action_Subject
{
    protected $lesson  			= null;
    protected $lesson_id  		= null;
    protected $subject_id 		= null;
    protected $curent_user_id 	= null;
    protected $curent_user_role = null;
    protected $_serviceJournal  = null;
    protected $_aclService  	= null;
	...
	public function indexAction(){
		...
		$this->view->lessonResult				= $this->getService('LessonAssign')->getRow($this->lesson_id, $this->curent_user_id);
	...
	public function extendedAction()
	{
		...
		$this->view->current_groupname 	= $group;
		#$this->view->current_groupname_name = $this->view->groupname[$group];
        ...
        $cols = array(
            ...
            'group_name' 		=> 'sg.name',
            'mark' 				=> 'sch.V_STATUS',    
            'ball_promotion' 	=> 'sch.ball_promotion',    
            'ball_academic' 	=> 'sch.ball_academic',    
            'ball_practic' 		=> 'sch.ball_practic',    
        );
		...
		$this->view->journalResult		= $this->_serviceJResult->getJournalResult($this->lesson_id);
		...
		$this->view->headScript()->appendFile(Zend_Registry::get('config')->url->base.'js/application/marksheet/index/index/script.js');
		$this->view->headLink()->appendStylesheet(Zend_Registry::get('config')->url->base.'css/content-modules/marksheet.css');
		
		#$this->getHelper('viewRenderer')->setNoRender();
		#echo $this->view->render('practice/extended_v2.tpl');
		#return false;
	}
