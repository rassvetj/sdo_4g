<?php
class Journal_LectureController extends HM_Controller_Action_Subject
{
	...
	public function extendedAction(){
		...
		$allowTutors 						= $this->lesson->allowTutors;
		
		$this->getService('Unmanaged')->setHeader(_('Журнал: ').$this->lesson->title);
