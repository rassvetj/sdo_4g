...
<table style="margin: 0 auto; border-collapse: collapse; text-align: center;">
	<tr>
		...
		<th rowspan="2" style="border: 1px solid black; font-weight: bold; vertical-align: middle;">Учебный план</th>					
		<th rowspan="2" style="border: 1px solid black; font-weight: bold; vertical-align: middle;">Группа</th>					
	...
	<tr>		
		...
		<td style="border: 1px solid black; padding: 3px;"><?=$i['name_plan'];?></td>													
