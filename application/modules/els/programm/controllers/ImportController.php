<?php
class Programm_ImportController extends HM_Controller_Action
{
    private $_importService = null;
    protected $_importManagerClass = 'HM_Programm_Import_Manager';
    ...
    public function csv()
    {
        ...
        $this->_importService = $this->getService('ProgrammCsv');
    }
    ...
    public function processAction()
    {
        ...
        $importManager = new HM_Programm_Import_Manager();
        ...
        $this->_redirector->gotoSimple('index', 'list', 'programm');
