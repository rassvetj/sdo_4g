...
class HM_Files_FilesModel extends HM_Model_Abstract
{
    ...
    const FILETYPE_HTML = 2;
    const FILETYPE_IMAGE = 3;
    const FILETYPE_AUDIO = 4;
    const FILETYPE_VIDEO = 5;
    const FILETYPE_FLASH = 6;
    const FILETYPE_DOC  = 7;
    const FILETYPE_XLS = 8;
    const FILETYPE_PPT = 9;
    const FILETYPE_PDF = 10;
    ...
    {
        $viewable = array(self::FILETYPE_AUDIO, self::FILETYPE_FLASH, self::FILETYPE_HTML, self::FILETYPE_IMAGE, self::FILETYPE_PDF, self::FILETYPE_TEXT, self::FILETYPE_VIDEO);
