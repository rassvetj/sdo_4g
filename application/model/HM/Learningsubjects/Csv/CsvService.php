<?php
class HM_Learningsubjects_Csv_CsvService extends HM_Service_Import_Abstract
{
    ...
    public function getForm()
    {
        ...
        $form->getElement('file')->setOptions(
            array(
                ...
                'file_types' => '*.csv',
                'file_upload_limit' => 1,
                'file_sample' => Zend_Registry::get('config')->url->base . 'samples/learningsubjects.csv',
            )
        );
