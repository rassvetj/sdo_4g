<?php
class HM_Debtors_Csv_CsvService extends HM_Service_Import_Abstract
{
    ...
    public function getForm()
    {
        ...
        $form->getElement('file')->setOptions(
            array(
                ...
                'file_types' => '*.csv',
                'file_upload_limit' => 1,                
                'file_sample' 		=> $form->getView()->url(array('module' => 'debtors', 'controller' => 'import', 'action' => 'get-example-file'), null, true),
            )
        );
