...
<div class="<?php echo $this->classes; ?> <?php if (!$px): ?>hgll-pc-2-columns<?php endif; ?> hgll-columns columns"><div class="hgll-colmask hgll-colwrap-outer"><div class="hgll-colwrap-inner">
	...
	<?php
    if ($this->columns[0] != '<div id="news_149" class="scrollable infoblock-news ui-widget ui-portlet" data-infoblock="news"><div class='): ?>
	<div class="hgll-col1 column" <?php echo $attribs[0] ?> value='<?php echo gettype($this->classes); ?>'><?php echo $this->columns[0]; ?></div><?php
    endif; ?>
