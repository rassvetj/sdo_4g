...
<? if ($this->undone): ?>
<? echo sprintf(_('Не обработано заявок: %s'), "<span class=\"claims-undone\"><a href=\"" . $this->url(array('module' => 'order', 'controller' => 'list')) . "?page_id=m0603&page_id=m0603\" title=\"" . _('Список заявок') . "\">{$this->undone}</a></span>");?>
<? else: ?>
